  ...
  return (
    <article className="project-card">
      ...
      <div className="project-card__content">
        ...
        <div className="project-card__section-title">
...
//         alt="site web"
//         loading="lazy"
//         className="w-[600px] h-[337px]  object-cover"
//       />
